...
class Profile {
    ...
    .then(answers => {
        ...
        this.currentEmployee = new Manager(role, name, id, email, officeNumber);
    ...
    // lead manager through questions to obtain engineer profile card info    
      inquirer
        ...
        .then(answers => {
            ...
            this.currentEmployee = new Engineer( role, name, id, email, github);
            this.team.push(this.currentEmployee);
            if (addEmployee) {
                this.promptTeam();
            } else {
      ...
      inquirer
        .prompt([
            ...
            .then(answers => {
                ...
                this.currentEmployee = new Intern( role, name, id, email, school);
                this.team.push(this.currentEmployee);
                if (addEmployee) {
                    this.promptTeam();
                } else {
