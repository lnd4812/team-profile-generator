...
class Profile {
    ...
    startTeamProfile() {
       // first step is to establish ee objects as arrays like this???? (one for each employee?)
        this.employees.push(new Employee('manager', 'name','id', 'email', 'officeNumber'));
        this.employees.push(new Employee('engineer','name','id', 'email', 'github'));
        this.employees.push(new Employee('intern', 'name','id', 'email', 'school'));
