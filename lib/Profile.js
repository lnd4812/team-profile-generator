...
class Profile {
    ...
    startTeamProfile() {
        ...
        // this.currentEmployee = this.employees.getRole();
    ...
    .then(answers => {
        ...
        this.currentEmployee = new Manager(name, id, email, officeNumber);
        this.team.push(this.currentEmployee);
    ...
    promptTeam() {
      ...
      inquirer
        ...
        .then(responses => {
            ...
            if (this.option === 'Engineer') {
                this.buildEngineer();            
            } else if (this.option === 'Intern') {
                this.buildIntern();
            } else {
    ...
    // lead manager through questions to obtain engineer profile card info    
      inquirer
        ...
        .then(answers => {
            ...
            this.currentEmployee = new Engineer( name, id, email, github);
            this.team.push(this.currentEmployee);
            console.log(this.team);
            if (addEmployee) {
                this.promptTeam();
    ...
    // lead manager through questions to obtain engineer profile card info            
      inquirer
        ...
        .then(answers => {
            ...
            this.currentEmployee = new Intern( name, id, email, school);
            this.team.push(this.currentEmployee);
            console.log(this.team);
            if (addEmployee) {
                this.promptTeam();
    ...
    buildTeamProfile = function() {
        // this.getRole() = "Manager" create manager profile card - export information to template
        // this.getRole() = "Engineer" or "Intern - create employee card for each employee added
        console.log(this.team); 
    }
}; 
