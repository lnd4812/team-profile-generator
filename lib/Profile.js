...
class Profile {
       ...
       // first step is to establish ee objects as arrays like this???? (one for each employee?)
        ...
        inquirer
          .prompt([
            ...
            if (this.currentEmployee.getRole() === 'manager' || 'Manager') {
                this.currentEmployee = new Manager(role);
            }
        ...
        .then(answers => {
            ...
            this.teams.push(this.employees);
    ...
    buildTeamProfile() {
        // const profilePage = 
        generateTeamTemplate(this.teams);
        // fs.writeFile('./dist/index.html', profilePage, err => {
